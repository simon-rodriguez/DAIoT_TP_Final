...
#define GRI_LED_GPIO CONFIG_GRI_ENABLE_TEMP_SUBPUB_LED_CONTROL_LED_GPIO_NUMBER

#ifdef CONFIG_GRI_ENABLE_TEMP_SUBPUB_LED_CONTROL_LED_RMT
...
static esp_err_t temperature_sensor_init()
{
    ...
    ESP_LOGI(TAG, "Initializing Temperature sensor - Lucky :)");
    ...
    ESP_LOGI(TAG, "Temperature sensor not initialized, not defined? - no luck :(");
    return ESP_OK;
#endif
}
...
#elif CONFIG_GRI_ENABLE_TEMP_SUBPUB_LED_CONTROL_LED_GPIO
